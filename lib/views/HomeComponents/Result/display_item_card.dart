...
class DisplayItemCard extends StatefulWidget {
  final String cate;
  final String uid;
  const DisplayItemCard({Key key, this.cate, this.uid}) : super(key: key);

  @override
  _DisplayItemCardState createState() => _DisplayItemCardState();
}

class _DisplayItemCardState extends State<DisplayItemCard> {
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (cartIt.contains(document.id)) {
                                        ...
                                        FirebaseFirestore.instance
                                            ...
                                            .update({
                                          'cartItems':
                                              FieldValue.arrayRemove(cartList),
                                          'cartTotalCost':
                                              (cost - dbCartCost).abs()
                                        }).then((value) {
                                          cost = 0;
